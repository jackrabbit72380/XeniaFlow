...
Global Const $INI = @ScriptDir & "\FlowMii.ini"
...
$Main_Flow_gui = GUICreate($Titel, 1024, 670, -1, -1, $WS_POPUP, $WS_EX_LAYERED)

GUICtrlCreateLabel('XeniaFlow', 0, 0, 1024, 30, $SS_CENTER, $GUI_WS_EX_PARENTDRAG)
GUICtrlSetFont(-1, 20, 800)

GUICtrlSetColor(-1, $GuiBorderColor)
GUICtrlSetBkColor(-1, $GuiColor)

GUICtrlCreateLabel('', 0, 670, 1024, 40)
GUICtrlSetBkColor(-1, $GuiColor)
GUICtrlSetState(-1, $GUI_DISABLE)

$Settings = GUICtrlCreatePic("", 10, 636, 32, 32)
_GUICtrlPic_SetImage($Settings, $TempFolder & "\settings.png")

$ExitButton = GUICtrlCreatePic("", 983, 636, 32, 32)
_GUICtrlPic_SetImage($ExitButton, $TempFolder & "\Exit.png")

$SkinBT = GUICtrlCreatePic("", 60, 636, 32, 32)
...
Global $device = CreateDeviceOnWindow($Main_Flow_gui, 4, 5, 32, 1280, 720, 32, 4, 4)
...
AddImage(GetTexture($TempFolder & "\ambientlight2.png"), 858, 0)
AddImage(GetTexture($TempFolder & "\ambientlight3.png"), 0, 420)
;===================================================================================================================================================================;
;========================================================================= GUI Settings ==========================================================================;
;===================================================================================================================================================================;
...
$parentgui = GUICreate("", 1024, 595, 0, 30, $WS_POPUP, BitOR($WS_EX_LAYERED, $WS_EX_MDICHILD), $Main_Flow_gui)
$Alphabet_gameName = GUICtrlCreateLabel('', 20, 0, 100, 50, $SS_CENTER)
GUICtrlSetFont(-1, 30, 600)
GUICtrlSetColor(-1, $AlphabColor)

$label_gameName = GUICtrlCreateLabel('', 0, 550, 1024, 50, $SS_CENTER)
GUICtrlSetFont(-1, 20, 400)
GUICtrlSetColor(-1, $TitleColor)

$next = GUICtrlCreateLabel(">>", 950, 300, 64, 64)
GUICtrlSetFont(-1, 30, 400)
GUICtrlSetColor(-1, 0xFFFFFF)

$perv = GUICtrlCreateLabel("<<", 20, 300, 64, 64)
GUICtrlSetFont(-1, 30, 400)
GUICtrlSetColor(-1, 0xFFFFFF)
			...
			If FileExists($FullCover_dir & "\" & $ListArray[$i][0] & ".png") = 1 Then
				...
				If FileExists($Cache_dir & "\" & $ListArray[$i][0] & "Left") = 0 Or FileExists($Cache_dir & "\" & $ListArray[$i][0] & "Right") = 0 Or FileExists($Cache_dir & "\" & $ListArray[$i][0] & "Center") = 0 Then
					...
					If $iImageType[1] = "png" Then
						...
						If $gdi_imageWidth = 1024 And $gdi_imageHeight = 680 Then

							; Get Left, Right & Center from back.png
							$gdi_hLeftImage = _GDIPlus_BitmapCloneArea($gdi_hImage, 0, 0, 485, $gdi_imageHeight, $GDIP_PXF32ARGB)
							$gdi_hRightImage = _GDIPlus_BitmapCloneArea($gdi_hImage, $gdi_imageWidth - 485, 0, 485, $gdi_imageHeight, $GDIP_PXF32ARGB)
							$gdi_hCenterImage = _GDIPlus_BitmapCloneArea($gdi_hImage, 485, 0, 54, $gdi_imageHeight, $GDIP_PXF32ARGB)
